  ...
  addJs(list) {
    ...
    if (typeof js === "function") {
      ...
      if (Array.isArray(jsAry)) {
        ...
        console.log(
          "\x1B[31m%s\x1B[39m",
          "The return value of the addJs must be an array in the html-extended-webpack-plugin"
        );
        process.exit(1);
      }
    }
    ...
    console.log(
      "\x1B[31m%s\x1B[39m",
      "addJs of value must be an array or a function in the html-extended-webpack-plugin"
    );
    process.exit(1);
  }
  addCss(list) {
    ...
    if (typeof css === "function") {
      ...
      if (Array.isArray(cssAry)) {
        ...
        console.log(
          "\x1B[31m%s\x1B[39m",
          "The return value of the addCss must be an array in the html-extended-webpack-plugin"
        );
        process.exit(1);
      }
    }
